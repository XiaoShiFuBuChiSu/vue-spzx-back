        ...
        <el-collapse-item title="商品基本信息" name="productBaseInfo">
          ...
          <el-form-item label="轮播图">
            <el-upload
              ...
              action="http://localhost:8501/api/system/file/upload"
...
import { FindCategoryByParentId } from '@/api/product/category'
import {
  GetProductPageList,
  SaveProduct,
  UpdateProductById,
...
import { FindBrandByCategoryId } from '@/api/product/brand'
import { FindAllProductUnit } from '@/api/basicData/productUnit'
import { FindAllProductSpec } from '@/api/product/productSpec'
